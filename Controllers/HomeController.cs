...
using EJDemoHelpdesk.Helpers;
using EJDemoHelpdesk.Models;

namespace EJDemoHelpdesk.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> PresentationRequest()
        {
            ...
            try
            {
                ...
                EJDemoHelpdesk.Models.PresentationRequest request = CreatePresentationRequest( null, null );
        ...
        public EJDemoHelpdesk.Models.PresentationRequest CreatePresentationRequest( string stateId = null, string credentialType = null ) {
            EJDemoHelpdesk.Models.PresentationRequest request = new EJDemoHelpdesk.Models.PresentationRequest() {
                ...
                registration = new Registration() {
                    clientName = _configuration.GetValue("VerifiedID:client_name", "EJ-DEMO"),
        ...
        public EJDemoHelpdesk.Models.PresentationRequest AddRequestedCredential( EJDemoHelpdesk.Models.PresentationRequest request
            ...
            request.requestedCredentials.Add( new RequestedCredential() {
                ...
                configuration = new EJDemoHelpdesk.Models.Configuration() {
        ...
        public bool IsFaceCheckRequested( EJDemoHelpdesk.Models.PresentationRequest request ) {
